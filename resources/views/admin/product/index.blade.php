            ...
            <div class="row">
                <div class="col-sm-12 mb-3">
                    <a href="{{ route('product.create') }}" class="btn btn-outline-secondary">
                        <i class="fas fa-plus nav-icon"></i> Thêm sản phẩm mới
                    </a>
                </div>
                <div class="col-md-12">
                    <div class="card card-primary card-outline p-1">
                        <div class="card-header">
                            <div class="row form-group">
                                <div class="col-sm-12">
                                    <form action="{{ route('product.index') }}" type="get">
                                        <div class="row">
                                            <div class="col-sm-4">
                                ...
                                @if($products->total() > 0)
                                    @foreach($products as $item)
                                        <tr>
                                            ...
                                            <td>
                                                {{ (new Helper())->price($item->price,$item->price_to,$item->value) }}
                                            </td>
                                            <td>
                        ...
                        <div class="card-footer clearfix">
                            <div class="row">
                                <div class="col-sm-2">
                                    <select name="" class="filter-change__product form-control" data-table="1">
