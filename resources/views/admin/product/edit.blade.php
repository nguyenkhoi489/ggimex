                                    ...
                                    <div class="tab-pane fade active show" id="default-tab" role="tabpanel"
                                        ...
                                        <div class="form-group row">
                                            <label for="staticEmail" class="col-sm-4 col-form-label">Giá
                                                tiền {{ $product->price_type == 1 ? "(từ)" : "" }}</label>
                                            <div class="col-sm-8">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="form-control" name="price_type">
                                                    <option value="0" @selected($product->price_type == 0)>Đơn giá
                                                    </option>
                                                    <option value="1" @selected($product->price_type == 1)>Khoảng Giá
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                        <div
                                            class="form-group row {{ $product->price_type == 0 ? "d-none" : "" }} price-to">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="form-control" name="is_active">
                                                    <option value="1" @selected($product->is_active == 1)>Kích hoạt
                                                    </option>
                                                    <option value="0" @selected($product->is_active == 0)>Không kích
                                                        hoạt
                                                    </option>
                                                </select>
                                            </div>
                                                ...
                                                <select class="form-control" name="categories_id">
                                                    @foreach($categories as $item)
                                                        <option value="{{ $item->id }}"
                                                            @selected($product->categories_id == $item->id )>
                                                            {{ $item->title }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-sm-8">
                                                <select class="form-control" name="prefix_id">
                                                    @foreach($prefix as $item)
                                                        <option value="{{ $item->id }}"
                                                            @selected($product->prefix_id == $item->id )>
                                                            {{ $item->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <input type="text" name="product_tags"
                                                       value="{{ $tags ? implode(',',(array) $tags->toArray()) : "" }}"
                                                       class="form-control"
                                                       placeholder="...">
                                            </div>
                                        </div>
                                                ...
                                                @foreach(json_decode($product->gallery) as $item)
                                                    <li data-url="{{ $item }}">
                                                        <span class="mailbox-attachment-icon">
                                                           <img src="{{ url($item) }}" width="100">
                                                        </span>
                                                        <div class="mailbox-attachment-info">
                                                            <a href="#" class="mailbox-attachment-name">
                                                                <i class="fas fa-paperclip"></i>{{ pathinfo($item)['basename'] }}</a>
