            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-primary card-outline p-4">
                        <div class="card-body">
                            <form action="{{ route('prefix.update',['id' => $prefix->id]) }}" method="post">
                                @csrf
                                @method('put')
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="custom-select" name="is_active">
                                            <option value="1" @selected($prefix->is_active == 1)>Kích hoạt</option>
                                            <option value="0" @selected($prefix->is_active == 0)>Không kích hoạt</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
