        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12 mb-3">
                    <a href="{{ route('slider.create') }}" class="btn btn-outline-secondary">
                        <i class="fas fa-plus nav-icon"></i> Thêm Slider
                    </a>
                </div>
                <div class="col-md-12">
                    <div class="card card-primary card-outline p-1">
                                ...
                                @if($sliders)
                                    @foreach($sliders as $item)
                                        <tr>
                                            ...
                                            <td>
                                                {{ (new App\Helper\Helper())->slider_type($item->type) }}
                                            </td>
                                            <td>
                                            ...
                                            <td class="text-center">
                                                ...
                                                <form method="post" class="d-inline"
                                                      action="{{ route('slider.destroy',['id' => $item->id]) }}">
                                                    @csrf
                                                    @method('delete')
                                                    <button type="submit"
                                                            data-toggle="tooltip"
                        ...
                        <div class="card-footer clearfix">
                            <div class="row">
                                <div class="col-sm-2">
                                    <select name="" class="filter-change__product form-control" data-table="8">
