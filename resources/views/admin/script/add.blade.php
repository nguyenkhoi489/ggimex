                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <textarea name="widget_code"
                                                  class="form-control">{{ old('widget_code') }}</textarea>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="custom-select" name="position">
                                            <option value="0" @selected(old('position') == 0)>Header</option>
                                            <option value="1" @selected(old('position') == 1)>After Body Tag</option>
                                            <option value="2" @selected(old('position') == 2)>Footer</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
