                    ...
                    <div class="card card-primary card-outline p-1">
                        ...
                        <form method="post" action="{{ route('posts.update',['id' => $post->id]) }}">
                            ...
                            <div class="card-body">
                                ...
                                <div class="tab-content">
                                    ...
                                    <div class="tab-pane fade active show" id="default-tab" role="tabpanel"
                                        ...
                                        <div class="form-group row">
                                            <label for="staticEmail" class="col-sm-4 col-form-label">Danh mục (*)</label>
                                            <div class="col-sm-8">
                                                <select class="form-control" name="categories_id">
                                                    @foreach($categories as $item)
                                                        <option value="{{ $item->id }}" @selected($post->id == $item->id)>{{ $item->title }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-8">
                                                <select class="form-control" name="is_active">
                                                    <option value="1" @selected($post->is_active == 1)>Kích hoạt
                                                    </option>
                                                    <option value="0" @selected($post->is_active == 0)>Không kích hoạt
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                            ...
                            <div class="card-footer clearfix">
                                <a href="{{ route('posts.index') }}" class="btn btn-default" data-dismiss="modal">Trở
                                    về</a>
